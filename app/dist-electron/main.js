...
let mainWindow = null;
let tray = null;
const MEDIA_PERMISSIONS = /* @__PURE__ */ new Set(["media", "audioCapture", "videoCapture"]);
const TRUSTED_HOSTS = /* @__PURE__ */ new Set(["localhost", "127.0.0.1", "::1"]);
function isTrustedOrigin(requestingOrigin) {
  try {
...
function configureMediaPermissions() {
  const defaultSession = require$$1$2.session.defaultSession;
...
function setupAutoLaunch() {
  ...
  require$$1$2.app.setLoginItemSettings({
    openAtLogin: autoLaunch,
    openAsHidden: false,
    path: require$$1$2.app.getPath("exe"),
    args: ["--auto-launched"]
  });
}
function createTray() {
  const icon = require$$1$2.nativeImage.createEmpty();
...
function createWindow() {
  ...
  mainWindow.on("close", (event) => {
    if (process.platform === "darwin" && !require$$1$2.app.isQuitting) {
...
require$$1$2.ipcMain.handle("minimize-window", () => {
  mainWindow == null ? void 0 : mainWindow.minimize();
});
require$$1$2.ipcMain.handle("maximize-window", () => {
...
require$$1$2.ipcMain.handle("close-window", () => {
  mainWindow == null ? void 0 : mainWindow.close();
});
require$$1$2.ipcMain.handle("get-auto-launch", () => {
  return store.get("autoLaunch", true);
});
require$$1$2.ipcMain.handle("set-auto-launch", (_event, enabled) => {
  store.set("autoLaunch", enabled);
  setupAutoLaunch();
  return enabled;
});
require$$1$2.ipcMain.handle("get-language", () => {
  return store.get("language", "zh");
});
require$$1$2.ipcMain.handle("set-language", (_event, language) => {
  store.set("language", language);
  return language;
});
require$$1$2.ipcMain.handle("is-auto-launched", () => {
